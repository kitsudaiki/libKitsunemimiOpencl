...
get_required_kitsune_lib_repo "libKitsunemimiCommon" "v0.18p.0" 4 "staticlib"
...
if [ $1 = "test" ]; then
    build_kitsune_lib_repo "libKitsunemimiOpencl" 4 "staticlib run_tests"
else
    build_kitsune_lib_repo "libKitsunemimiOpencl" 4 "staticlib"
fi
